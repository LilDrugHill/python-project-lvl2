...
def test_simple_gendiff_json():
    ...
    file1 = 'gendiff/tests/fixtures/simple_files/file1.json'
    file2 = 'gendiff/tests/fixtures/simple_files/file2.json'
...
def test_depth_gendiff_json():
    ...
    file1 = 'gendiff/tests/fixtures/deep_files/file1.json'
    file2 = 'gendiff/tests/fixtures/deep_files/file2.json'
