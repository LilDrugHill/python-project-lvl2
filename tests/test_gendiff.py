...
TESTS_DIR = os.path.dirname(os.path.abspath('tests/fixtures'))
...
def test_gendiff(file1, file2, output_format, output_file):
    file_path1 = FIXTURES_PATH + file1
    file_path2 = FIXTURES_PATH + file2
    output_path = FIXTURES_PATH + output_file
